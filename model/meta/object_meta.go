...
type ObjectMeta struct {
	...
	CreateTimestamp time.Time `json:"createTimestamp" db:"create_timestamp" bson:"create_timestamp" gorm:"column:create_timestamp"`

	// Creator 创建人Name
	Creator string `json:"creator" db:"creator" bson:"creator" gorm:"column:creator"`

	// ModifyTimeStamp 资源更新时间戳
	ModifyTimestamp time.Time `json:"modifyTimestamp" db:"modify_timestamp" bson:"modify_timestamp"gorm:"column:modify_timestamp"`
	...
	DeleteTimestamp time.Time `json:"deleteTimestamp" db:"delete_timestamp" bson:"delete_timestamp" gorm:"column:delete_timestamp"`
